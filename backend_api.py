...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://pdfocr-2kqm0juns-navneet-mittals-projects.vercel.app", "https://pdfocrapp.vercel.app", "http://localhost:5173", "http://localhost:3000"],
...
print(f"[BACKEND] JSON_DIR: {JSON_DIR}")
